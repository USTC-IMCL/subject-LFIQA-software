...
class Ui_LogForm(object):
    def setupUi(self, LogForm):
        ...
        LogForm.resize(765, 501)
        icon = QIcon()
        icon.addFile(u"jpegpleno-logo.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"color: rgb(255, 255, 255);")
        ...
        self.logo_label.setPixmap(QPixmap(u"LOGO_imcl_transparent.png"))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(280, 100, 451, 311))
        ...
        self.button_start = QPushButton(self.verticalLayoutWidget)
        self.button_start.setObjectName(u"button_start")
        self.button_start.setMinimumSize(QSize(220, 70))
        font1 = QFont()
        ...
        self.horizontalLayout.addWidget(self.button_new_experiment)
        ...
        self.button_about.clicked.connect(LogForm.close)

        QMetaObject.connectSlotsByName(LogForm)
    # setupUi

    def retranslateUi(self, LogForm):
        LogForm.setWindowTitle(QCoreApplication.translate("LogForm", u"JPEG Pleno Light Field imag Quality Assessment Software", None))
        ...
        self.button_start.setText(QCoreApplication.translate("LogForm", u"Start Experiment", None))
        self.button_new_experiment.setText(QCoreApplication.translate("LogForm", u"New Experiment", None))
